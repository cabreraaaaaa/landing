...
function updateBlueClock() {
    const clockEl = document.getElementById('blue-bg-clock');
    if (!clockEl) return;
    const now = new Date();
...
setInterval(updateBlueClock, 1000);
updateBlueClock();